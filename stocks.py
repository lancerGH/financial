...
#1-2把投资组合历史数据清理成可用的DataFrame数据结构，对象portfolio_data
data_list=[]
...
market_data=pd.DataFrame(data_list,columns=market.fields)
#2-3结果集输出到CSV文件
market_data.to_csv("market_history_data.csv",index=False)
